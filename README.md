...
### useReducer 
returns state and dispatch, and accepts the reducer and the initial value of the state as an argument.  It also accepts an init argument to work on state but this feels pretty edge case and I am going to disregard it here.

### Reducer:  
a function containing a switch statement which specifies how state is updated, in this case a state object.  If your state is not an object containing at least two key value pairs, you should probably be using useState instead.
